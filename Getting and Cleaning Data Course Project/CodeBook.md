...
_Thus, for each record it is provided:
...
The following is a list of names of the 561 features, which can also be checked in the features.txt file:
For details on their meaning refer to the Feature Selection which lists the original array names and the measurements derived from the array. 
